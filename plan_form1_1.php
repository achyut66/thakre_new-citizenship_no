...
get_access_to_second_form($_GET['id']);
...
<body>
                            ...
                            <form method="post" enctype="multipart/form_data">
                               ...
                               <table class="detail_post table table-bordered table-hover">
                                ...
                                <?php } else {?>
                                    ...
                                    <td><input type="text" name="cit_no[]"  value="<?=$group_detail->cit_no?>" class="input100percent citizen_no" required/></td>
    ...
    <script type="text/javascript">
      JQ(document).on("input",".citizen_no",function() {
          var obj = JQ(this).val();
